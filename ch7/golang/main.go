...
func createConfig(provider oidc.Provider) (oidc.Config, oauth2.Config) {
	...
	config := oauth2.Config{
		...
		ClientSecret: "mCQHy1lPzfRYsPM47DMF6HHWJaSfZRI2", // change CLIENT_SECRET with the secret generated by Keycloak for the mywebapp client. This option is a string.
